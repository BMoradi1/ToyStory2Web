/** Browser regression: original visor and live creature target locking.
 * npm run dev
 * npx tsx tools/browser-shot.ts "Toy Story 2" /tmp/aim-lock.png --eval-file tools/aim-lock-flow-check.js
...
(async () => {
  ...
  console.log('PASS: real E binding, target lock, held edge, pause, manual release, re-lock and dead-target cleanup');
})();
